...
import { isValidWeekStart, loadWeeklyPlans, saveWeeklyPlan, setTaskDone, weekStartFor, MAX_WEEKLY_TASKS } from '@/lib/portal/weekly-plan'
 ...
 * PATCH → check a task off. All scoped to the session client; the table
 * missing just reads as "no plans".
 */
