...
**`066_publish_360_brief_v2_1.sql` — PENDING (data only, no schema).** Publishes
`assessment_360` **v2.1** (rubrics/04, calibrated against the reference report;
v3 in the table after 065's v2). Generated by `publish-brief.js assessment_360
--sql`; idempotent; safe before or after 065. Reversible via the down-script.
