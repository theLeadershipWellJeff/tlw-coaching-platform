...
// Org-scoped, RLS-honoring data access does NOT go through supabase-js: this
// project verifies JWTs with an asymmetric signing key the app cannot self-sign,
// so a minted-JWT PostgREST client can't authenticate. Tenant-scoped reads use a
// direct pooled Postgres connection instead — see lib/supabase/pg.ts#withOrgClaim.
