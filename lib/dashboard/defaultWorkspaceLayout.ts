...
export const DEFAULT_WORKSPACE_LAYOUT: CardPlacement[] = [
  ...
  { blockId: 'ws-session-plans', size: 'standard', order: 1 },
  { blockId: 'ws-transcripts', size: 'compact', order: 2 },
  { blockId: 'ws-notes', size: 'compact', order: 3 },
  { blockId: 'ws-goals', size: 'standard', order: 4 },
  { blockId: 'ws-actions', size: 'standard', order: 5 },
  { blockId: 'ws-nudges', size: 'standard', order: 6 },
  { blockId: 'ws-communications', size: 'standard', order: 7 },
  { blockId: 'ws-agreements', size: 'standard', order: 8 },
  { blockId: 'ws-agenda', size: 'compact', order: 9 },
