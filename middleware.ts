 ...
 * cookie, EXCEPT the public login + verify pages and the confidentiality
 * statement (/portal/privacy), which a participant reads before first login. A coach's NextAuth session is
 ...
 */
const PUBLIC_PATHS = ['/portal/login', '/portal/verify', '/portal/privacy']
