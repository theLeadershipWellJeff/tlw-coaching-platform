...
values (
  null,
  '<table cellpadding="0" cellspacing="0" style="margin-top:24px;border-top:1px solid #e5e0d8;padding-top:16px;font-family:''DM Sans'',Helvetica,Arial,sans-serif;"><tr><td style="padding-right:14px;vertical-align:middle;"><img src="https://theleadershipwell.online/logo-email.png" width="40" height="40" alt="theLeadershipWell" style="display:block;border:0;" /></td><td style="vertical-align:middle;"><div style="font-weight:700;font-size:14px;color:#111226;">Jeff Holmes</div><div style="font-size:12px;color:#8B8680;margin-top:1px;">Executive Coach &middot; theLeadershipWell</div><div style="font-size:12px;color:#8B8680;margin-top:4px;"><a href="mailto:jeff@jeffkholmes.com" style="color:#0C1940;text-decoration:none;">jeff@jeffkholmes.com</a>&nbsp;&middot;&nbsp;<a href="https://www.theleadershipwell.com" style="color:#0C1940;text-decoration:none;">theleadershipwell.com</a></div></td></tr></table>',
